 ...
 */
import { aiContextService } from '../core/ai/ai-context-service.js';
...
export class AIChatComponent {
    ...
    async sendMessage() {
        if (!this.input?.value.trim() || !this.sendButton)
            return;
        ...
        try {
            ...
            const response = await aiContextService.sendMessage(request);
            // Отображаем ответ AI
            this.displayMessage({
                role: 'assistant',
...
//# sourceMappingURL=AIChatComponent.js.map