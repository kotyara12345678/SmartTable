...
export class SettingsPanelComponent {
    ...
    setupAutoSaveHandlers() {
        ...
        // Ползунок интервала
        const intervalRange = document.getElementById('autosaveIntervalRange');
    ...
    updateAutoSaveStatus() {
        ...
        if (!status.enabled) {
            ...
            if (text)
                text.textContent = 'Автосохранение отключено';
        }
            ...
            if (timeUntil !== null) {
                ...
                if (text)
                    text.textContent = `Есть несохраненные изменения. Сохранение через ${mins}м ${secs}с`;
            }
            else {
                if (text)
                    text.textContent = 'Есть несохраненные изменения';
            }
        }
        else {
            if (indicator) {
            ...
            if (status.lastSaveTime) {
                ...
                if (text)
                    text.textContent = `Последнее сохранение: ${timeStr}`;
            }
            else {
                if (text)
                    text.textContent = 'Автосохранение включено';
            }
        }
    }
