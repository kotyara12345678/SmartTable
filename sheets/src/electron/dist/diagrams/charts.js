...
export function analyzeDataAndSuggestChartType(data) {
...
export function getColor(index, customColors) {
...
export function createChart(canvas, data, type = 'bar', title = 'Диаграмма') {
    const config = {
        type,
        title,
        datasets: [{
